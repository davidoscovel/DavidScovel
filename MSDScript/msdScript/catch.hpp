...
////////////////////////////////////////////////////////////////////////////////
// Android somehow still does not support std::stringify
...
#   define _BSD_SOURCE
// some versions of cygwin (most) do not support std::stringify. Use the libstd check.
...
namespace Matchers {
    ...
    namespace Floating {
        ...
        // |lhs - actualArg| <= epsilon * max(fabs(lhs), fabs(actualArg)), then we get
...
// Performs equivalent check of std::fabs(lhs - actualArg) <= margin
